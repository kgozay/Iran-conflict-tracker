...
export default {
  ...
  safelist: [
    ...
    'text-bull','text-bear','text-warn','text-ts','text-tm','text-tp','text-tx',
    'bg-bull','bg-bear','bg-warn','bg-ts','bg-paper',
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        ink:     'var(--color-ink)',
        bull:    'rgba(var(--color-bull-rgb), <alpha-value>)',
        'bull-d':'var(--color-bull-d)',
        bear:    'rgba(var(--color-bear-rgb), <alpha-value>)',
        'bear-d':'var(--color-bear-d)',
        warn:    'rgba(var(--color-warn-rgb), <alpha-value>)',
        'warn-d':'var(--color-warn-d)',
      },
      fontFamily: {
      ...
      keyframes: {
        ...
        dataFlash: {'0%':{backgroundColor:'rgba(232,176,74,.15)'},'100%':{backgroundColor:'transparent'}},
